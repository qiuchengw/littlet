...
// convert
inline CStdString IntToStr(int nVal)
{
    TCHAR buff[20];
    _itot_s(nVal, buff, 20, 10);
    return buff;
}

inline CStdString LongToStr(long lVal)
{
    TCHAR buff[40];
    _ltot_s(lVal, buff, 40, 10);
    return buff;
}

inline CStdString ULongToStr(unsigned long ulVal)
{
    TCHAR buff[40];
    _ultot_s(ulVal, buff, 40, 10);
    return buff;
}

inline CStdString DblToStr(double dblVal, int ndigits)
{
    char buff[50];
...
inline CStdString DblToStr(double fltVal)
{
    char buff[50];
    _gcvt_s(buff, 50, fltVal, 5);
    return buff;
}
