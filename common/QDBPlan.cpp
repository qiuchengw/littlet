...
BOOL QDBPlan::EditPlan( int nID,const QString& sPlan,
...
BOOL QDBPlan::EditStage( __in int nStageID, const QString& sStage, 
    const QString& sDes, QTime tmBegin, QTime tmEnd )
{
    QString sQ;
...
BOOL QDBPlan::EditGoal( int nGoalID, const QString& sGoal, const QString& sDes)
{
    QString sQ;
...
BOOL QDBPlan::EditGoalItem( int nGoalItemID, const QString& sItem, QTime tmBegin, QTime tmEnd )
{
	QString sQ;
...
BOOL QDBPlan::SetGoalItemNotes(int nGoalItemID,const QString &sNotes)
{
    ASSERT(FALSE);
    return FALSE;
