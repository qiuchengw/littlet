...
protected:
	...
	BOOL EditPlan(int nID,const QString& sPlan, const QString& sDes, QTime tmBegin, QTime tmEnd);
...
protected: // stage
    ...
    BOOL EditStage(__in int nStageID, const QString& sStage, 
...
protected: // goal
    ...
    BOOL EditGoal( int nGoalID, const QString& sGoal, const QString& sDes);
...
protected: // goalitem
    ...
    BOOL EditGoalItem( int nGoalItemID, const QString& sItem, QTime tmBegin, QTime tmEnd );
    BOOL SetGoalItemNotes(int nGoalItemID,const QString &sNotes);
...
protected: // note
	...
	int GetNote_WithTags(const QString& sTag,__out VecNote& vn);
