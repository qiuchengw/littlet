...
int QResDB::GetDataItems( __out VecFileData& vfd ,DWORD eType)
{
	...
	QString sQ = L"SELECT ID,DataType,DataSize,Name,Ext,Refs FROM tbl_data";
...
//////////////////////////////////////////////////////////////////////////
BOOL QResMan::Startup( QString sIconDir )
{
...
QString QResMan::GetDBResFilePath( __in TFileData& tfd )
{
    QString sRet;
    switch (tfd.eType)
    {
...
QString QResMan::GetDBResFilePath( __in int nID )
{
    if (INVALID_ID != nID)
    {
        TFileData tfd;
...
QString QResMan::ReleaseDataToFile( int nID )
{
	TFileData t;
	if (QResDB::GetInstance()->GetData(nID,TRUE, t))
    {
