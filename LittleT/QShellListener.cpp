...
BOOL QShellListener::HandleShellRequest( __in wchar_t* pMsg, __in DWORD nLen, __out QString& sReply )
{
...
BOOL QShellListener::ReplyShellRequest( __in HANDLE hPipe, __in const QString& sReply )
{
    DWORD cbWritten = 0;
    DWORD cbReplyBytes = sReply.GetLength() * sizeof(QString::size_type);
