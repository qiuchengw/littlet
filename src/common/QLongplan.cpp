...
CStdString GetTimeFleeText(QTimeSpan &tmSpan)
{
...
BOOL QGoalItem::Edit( const CStdString& sItem, QTime tmBegin, QTime tmEnd )
{
...
BOOL QGoal::EditGoal( const CStdString& sGoal, const CStdString& sDes )
{
...
BOOL QPlan::Edit( const CStdString& sPlan, const CStdString& sDes, QTime tmBegin, QTime tmEnd )
{
...
CStdString QPlan::IconPath() const
{
...
CStdString QStage::GetTimeFlee()
{
	return GetTimeFleeText(QTime::GetCurrentTime() - BeginTime());
}

BOOL QStage::Edit( const CStdString& sStage, 
...
CStdString QStage::IconPath() const
{
    return QResMan::GetInstance()->GetDBResFilePath(IconID());
}
